...
const produto = ref({
  ...
  descricaoCompleta:
    'Uma descrição mais detalhada do software, explicando suas principais funcionalidades e benefícios.',
...
// deletar produto, somente se não houver squad
function del(uuid) {
  if (auth.getSquad() == false) {
    product.del(uuid)
